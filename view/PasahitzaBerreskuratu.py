...
class PasahitzaBerreskuratu(object):
    ...
    def __init__(self):
        ...
        espacio= tk.Label(self.window,
                          bg=atzeko_kolor,
                          text="",
                          font=("Times New Roman", 7))
        izenburu1 = tk.Label(self.window,
                             bg=atzeko_kolor,
                             text='PASAHITZA',
                             font=("Times New Roman", 25))
        izenburu1.pack()
        izenburu2 = tk.Label(self.window,
                             bg=atzeko_kolor,
                             text='BERRESKURATU',
                             font=("Times New Roman", 25))
        izenburu2.pack()

        azpiIzenb = tk.Label(self.window,
                             bg=atzeko_kolor,
                             text='Zure pasahitza berreskuratzeko: ',
                             font=("Calibri"))
        azpiIzenb.pack()
        ...
        erab = tk.Label(self.window,
                        bg=atzeko_kolor,
                        text='Sartu zure erabiltzailearen izena... ',
                        font=("Times New Roman", 16))
        erab.place(x=60, y=170)

        self.lehio = tk.Entry(self.window,
                              bg=botoi_kolor,
                              justify=tk.LEFT,
                              width=26 ,
                              font=("Times New Roman", 16))
        ...
        self.buttonados = tk.Button(self.window,
                                    cursor="hand2",
                                    bg=botoi_kolor,
                                    text="Ados",
                                    width=8,
                                    font="Calibri",
                                    command=self.berreskuratuta)
    ...
    def berreskuratuta(self):
        id = self.lehio.get()
        if len(id) != 0:
            erabiltzaile = JokalariZerrenda().get_erabiltzailea_idz(id)
