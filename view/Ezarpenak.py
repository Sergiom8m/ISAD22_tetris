...
class Ezarpenak(object):
    ...
    def __init__(self, erabiltzaile):
        ...
        global atzeko_kolor
        atzeko_kolor = erabiltzaile.atzeko_kolore if erabiltzaile is not None else "#7ec0ee"
        global botoi_kolor
        botoi_kolor = erabiltzaile.botoi_kolore if erabiltzaile is not None else "#ffffff"
