...
class Erregistroa(object):
    ...
    # BOTOIAK
    sartu = tk.Button(window, text="Sartu", cursor="hand2", bg=botoi_kolor, width=10, font=("Times New Roman", 14))
    sartu.place(x=410, y=405)

    irten = tk.Button(window, text="Irten", cursor="hand2", bg=botoi_kolor, width=10, font=("Times New Roman", 14))
    irten.place(x=230, y=405)
    ...
    erab.place(x=220, y=120)

    erabil = tk.Entry(window, textvar=identifik, width=30, bg=sarrera_kolor, font=("Times New Roman", 16))
    erabil.place(x=210, y=150)
    identifik = ttk.Entry(justify=tk.LEFT)

    # Pasahitzaren sarrera
    pas1 = ttk.Label(window, text='Pasahitza... ', font=("Times New Roman", 16))
    pas1.place(x=220, y=220)

    pasahitz1 = tk.Entry(window, textvar=pasahitza1, width=30, bg=sarrera_kolor, font=("Times New Roman", 16))
    pasahitz1.place(x=210, y=250)
    pasahitz1 = ttk.Entry(justify=tk.LEFT)

    pas2 = ttk.Label(window, text='Pasahitza errepikatu... ', font=("Times New Roman", 16))
    pas2.place(x=220, y=320)

    pasahitz2 = tk.Entry(window, textvar=pasahitza2, width=30, bg=sarrera_kolor, font=("Times New Roman", 16))
    pasahitz2.place(x=210, y=350)
